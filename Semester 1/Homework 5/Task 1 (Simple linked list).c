/*
Simple linked list (only basic functions were implemented).
...
// Returns first element and deletes it from the list
...
// Returns last element and deletes it from the list
...
// Converts a given string and calls the appropriate command
